...
function getDepartment(){
    $.ajax({
        type: 'GET',
        url: "http://localhost:1000/admin/index.php?language=vi&nv=register&op=get_department",
        data: {
        },
        dataType: 'html',
        success: function(respon) {
...
function getDepartmentChildren(){
    $('#unit').change(function() {
        let unit_id = $(this).val();
        $.ajax({
            type: 'GET',
            url: "http://localhost:1000/admin/index.php?language=vi&nv=register&op=get_department_children&parent_id="+unit_id,
            dataType: 'html',
            success: function (respon) {
                if (!respon.success) {
                    $('#unit_children').html(respon);
                }
            },
            error: function (jqXHR, textStatus, errorThrown) {
                alert('Request Error!!!');
...
function getSchool(){
    $('#unit_children').change(function() {
        let unit_id = $(this).val();
        $.ajax({
            type: 'GET',
            url: "http://localhost:1000/admin/index.php?language=vi&nv=register&op=get_school&parent_id="+unit_id,
            dataType: 'html',
            success: function (respon) {
                if (!respon.success) {
                    $('#select-school').html(respon);
                }
            },
            error: function (jqXHR, textStatus, errorThrown) {
                alert('Request Error!!!');
